...
import { augustIssueArticles } from '@/data/navalHistoryAugust2026'

// The full August 2026 table of contents — all 25 items, transcribed from the
// issue page on usni.org.
const articles: Article[] = augustIssueArticles
...
export default function NavalHistoryIssueArticles() {
      ...
      <div className="container-site">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-border-light">
          <span className="font-body text-sm text-neutral-subtle">
            {articles.length} articles · August 2026
          </span>
